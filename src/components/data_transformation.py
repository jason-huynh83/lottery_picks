...
class DataTransformation:
    ...
    def add_totals(self, df_running, df):
        ...
        try:
            ...
            df.loc['Total'] = df.sum()
            df.loc['Total - 10%/20%'] = [df.loc['Total','bs']-bs_total, df.loc['Total','3n']-n_total]
            df.loc['final_total'] = [np.nan, df.loc['Total - 10%/20%', 'bs'] + df.loc['Total - 10%/20%', '3n']]
    ...
    def add_totals_2(self, df_running, df):
        ...
        try:
            ...
            buy_backs_3n['bet'] = buy_backs_3n['bet'].apply(lambda x: x-80)
            buy_backs_bs['bet'] = buy_backs_bs['bet'].apply(lambda x: x-160)
