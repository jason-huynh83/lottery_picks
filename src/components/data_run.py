...
class DataFinal:
    ...
    def data_main_2(self, final_df, buy_back_bonus, buy_back_3n, bb_bonus_perct, bb_3n_perct):
        logging.info("Data Transformation is complete")
        logging.info("Entered DataFinal - data_main")
        try:
            data_obj = DataTransformation()
            ...
            if len(final_df1.columns) > 2:
                to_send, buy_back = data_obj.add_totals_2(final_df1, df, buy_back_bonus, buy_back_3n, bb_bonus_perct, bb_3n_perct)
            else:
                to_send, buy_back = data_obj.add_total_bs(final_df1, df, buy_back_bonus, bb_bonus_perct, bb_3n_perct)
